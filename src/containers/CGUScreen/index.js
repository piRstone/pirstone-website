...
import eatuntilLogo from "../../images/eatuntil-logo.svg";
  ...
  return (
    <div className="my-5">
      <div className="d-flex flex-column align-items-center mb-5">
        <Link to="/eatuntil">
          <Logo src={eatuntilLogo} alt="Eat Until logo" className="mb-3" />
        </Link>
      ...
      <Text>
        ...
        accessibles sur le site à la rubrique «CGU». Toute inscription ou
        utilisation du site implique l'acceptation sans aucune réserve ni
        restriction des présentes CGU par l’utilisateur. Lors de l'inscription
        ...
        suivant : « Je reconnais avoir lu et compris les CGU et je les accepte
      ...
      <SubTitle>ARTICLE 1 : LES MENTIONS LÉGALES</SubTitle>
      <Text>
        L’édition et la direction de la publication du site
        eatuntil.pirstone.com est assurée par Pierre Lavalley, domicilié Nantes.
        Adresse e-mail eatuntil@pirstone.com. L'hébergeur du site
        eatuntil.pirstone.com est la société Scaleway, dont le siège social est
        situé au 8 rue de la Ville l’Evêque, 75008 Paris, France.
      </Text>
      <SubTitle>ARTICLE 2 : ACCÈS AU SITE</SubTitle>
      <Text>
        Le site eatuntil.com permet à l'Utilisateur un accès gratuit aux
        services suivants : Le site internet propose les services suivants :
        lister les produits afin qu'ils soient consommés avant leur date de
        péremption Le site est accessible gratuitement en tout lieu à tout
        ...
        Celle-ci sera effective dans un délai raisonnable. 1 /3 Tout événement
        dû à un cas de force majeure ayant pour conséquence un dysfonctionnement
        du site ou serveur et sous réserve de toute interruption ou modification
        en cas de maintenance, n'engage pas la responsabilité de eatuntil.com.
      ...
      <SubTitle>ARTICLE 3 : COLLECTE DES DONNÉES</SubTitle>
      <Text>
        ...
        : · par mail à l'adresse mail eatuntil@pirstone.com · via son espace
        personnel ;
      </Text>
      <SubTitle>ARTICLE 4 : PROPRIÉTÉ INTELLECTUELLE</SubTitle>
      <Text>
      ...
      <SubTitle>ARTICLE 5 : RESPONSABILITÉ</SubTitle>
      <Text>
        Les sources des informations diffusées sur le site eatuntil.com sont
        ...
        Malgré des mises à jour régulières, le site eatuntil.com ne peut être
        ...
        responsabilité. 2 /3 Le site eatuntil.com ne peut être tenu pour
      ...
      <SubTitle>ARTICLE 6 : LIENS HYPERTEXTES</SubTitle>
      <Text>
        ...
        eatuntil.com. Ce dernier n’a pas de contrôle sur les pages web sur
        lesquelles aboutissent ces liens et ne saurait, en aucun cas, être
        responsable de leur contenu
      </Text>
      <SubTitle>ARTICLE 7 : COOKIES</SubTitle>
      <Text>
        ...
        nécessaires à l’utilisation du site eatuntil.com. Les cookies ne
        ...
        eatuntil.com. En naviguant sur le site, L’Utilisateur les accepte.
